...
m1 = foxsi_image_map( data_lvl2_d1, cen1_pos2, erange=[5.,10.], trange=trange, thr_n=4., /xycorr )
plot_map, m1, /limb, lcol=255, col=255, charsi=1.2, title=m1.id
draw_fov,det=1,target=1
...
m = foxsi_image_map(data, cen1_pos2, erange=[5.,10.], trange=trange, thr_n=4., /xycorr )
