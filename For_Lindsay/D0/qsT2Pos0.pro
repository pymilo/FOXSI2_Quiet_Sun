...
trange=[t2_pos0_start,t2_pos0_end]
m0 = foxsi_image_map( data_lvl2_d0, cen2_pos0, erange=[5.,10.], trange=trange, thr_n=4., /xycorr )
plot_map, m0, /limb, lcol=255, col=255, charsi=1.2, title=m0.id
draw_fov,det=0,target=2,shift=CEN2_POS0-CEN2_POS1
...
m = foxsi_image_map(data, cen2_pos0, erange=[5.,10.], trange=trange, thr_n=4., /xycorr )
