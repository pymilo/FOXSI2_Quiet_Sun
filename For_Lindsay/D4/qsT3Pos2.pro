...
m4 = foxsi_image_map( data_lvl2_d4, cen3_pos2, erange=[5.,10.], trange=trange, thr_n=4., /xycorr )
plot_map, m4, /limb, lcol=255, col=255, charsi=1.2, title=m4.id
draw_fov,det=4,target=3
...
m = foxsi_image_map(data, cen3_pos2, erange=[5.,10.], trange=trange, thr_n=4., /xycorr )
