...
m6 = foxsi_image_map( data_lvl2_d6, cen2_pos1, erange=[5.,10.], trange=trange, thr_n=4., /xycorr )
plot_map, m6, /limb, lcol=255, col=255, charsi=1.2, title=m6.id
draw_fov,det=6,target=2
...
m = foxsi_image_map(data, cen2_pos1, erange=[5.,10.], trange=trange, thr_n=4., /xycorr )
